  ...
  <div class="game-details border-b border-gray-400 pb-12 flex flex-col lg:flex-row">
    ...
    <div class="lg:ml-12 lg:mr-64">
      <h2 class="font-semibold text-4xl leading-tight mt-1">
        ...
        @else
          <svg class="inline" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" width="15" height="15"><path d="M4.5 6.5v-3a3 3 0 016 0v3m-8 0h10a1 1 0 011 1v6a1 1 0 01-1 1h-10a1 1 0 01-1-1v-6a1 1 0 011-1z" stroke="currentColor"></path></svg>
        @endauth
      </h2>
      <div class="text-gray-400">
        ...
        @forelse($game->developers as $developer)
          <span>{{ $developer->name }}@if(!$loop->last),@endif</span>
        @empty
